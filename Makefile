...
all:
	g++ -DHAVE_CONFIG_H -I$(ODEPath)/ode/demo -I$(ODEPath)/ode/src  -I$(ODEPath)/include -I$(ODEPath)/include -DDRAWSTUFF_TEXTURE_PATH="\"/home/pzpzpzp1/Desktop/ode-0.13/drawstuff/textures\"" -DdTRIMESH_ENABLED   -g -O2 -MT nest.o -MD -MP -MF ./nest.Tpo -c -o nest.o nest.cpp
